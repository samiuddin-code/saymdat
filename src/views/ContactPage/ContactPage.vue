...
textarea:focus {
  border-color: #000;
  outline: none;
  border-bottom: 2px solid #000; /* Change bottom border color on focus */
}
      ...
      .contact-cards {
        ...
        .contact-card {
          ...
          .icon {
            ...
            &.email-icon::before {
              content: "\2709"; // Envelope icon (Unicode)
            }

            &.location-icon::before {
              content: "\1F4CD"; // Location pin icon (Unicode)
            }
          }
